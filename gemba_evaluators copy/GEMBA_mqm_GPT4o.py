...
translation_folder = "/Users/cameronpattison/Library/CloudStorage/OneDrive-Vanderbilt/For Publication/Machine Translation Article/Translation_stuff/Translations/gpt4o_translations_11.14.24"
...
def main():
    ...
    with open('gpt4o_evaluation_results.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=2)

    print("Evaluation complete. Results saved to gpt4o_evaluation_results.json")

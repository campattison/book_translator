...
translation_folder = "/Users/cameronpattison/Library/CloudStorage/OneDrive-Vanderbilt/For Publication/Machine Translation Article/Translation_stuff/Translations/gemini_translations_11.14.24"
...
def main():
    ...
    # Save results to a JSON file with the new name
    with open('gemini_evaluation_results.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=2)

    print("Evaluation complete. Results saved to gemini_evaluation_results.json")
